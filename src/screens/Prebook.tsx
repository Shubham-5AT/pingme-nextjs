        ...
        <div className="pb">
          ...
          {success && (
            <div className="success-wrap fade-up">
              ...
              <div className="success-btns">
                ...
                <button className="btn-secondary" onClick={() => router.push("/profile")}>My Profile</button>
                <button className="btn-secondary" onClick={() => router.push("/products")}>Shop More</button>
              </div>
            </div>
          )}
          ...
          {!success && items.length === 0 && (
            <div className="empty-wrap fade-up">
              ...
              <button className="btn-primary" style={{ padding: "0 28px" }} onClick={() => router.push("/products")}>
                Browse Products
              </button>
            </div>
          )}
