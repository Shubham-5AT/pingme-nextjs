...
import type { NFCProfileData, NFCProjectData, NFCDocumentData } from "@/components/NFCProfileBuilder";
...
export default function Profile() {
  ...
  const buildNfcDraft = (order: PrebookingRecord, nfcProfile?: NFCProfile): NFCProfileData => ({
    ...
    bio: nfcProfile?.bio || "",
    businessOverview: nfcProfile?.businessOverview || "",
    ...
    companyAddress: nfcProfile?.companyAddress || "",
    googleMapsLink: nfcProfile?.googleMapsLink || "",
    ...
    projects: (nfcProfile?.projects || []) as NFCProjectData[],
    documents: (nfcProfile?.documents || []) as NFCDocumentData[],
  });
