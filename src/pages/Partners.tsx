    ...
    <MainLayout>
      <section className="relative overflow-hidden bg-neutral-950 py-14 md:py-20 text-stone-100">
        ...
        <div className="container relative space-y-12">
          ...
          <div className="mt-10 rounded-2xl border border-white/15 bg-black/60 p-6 backdrop-blur-sm shadow-[0_0_40px_rgba(250,204,21,0.06)]">
            <h2 className="text-lg font-bold mb-3 text-white">Become a Partner</h2>
            <p className="text-stone-300 mb-4">Interested in bringing PingME to your gym, society, or office? Contact us:</p>
            <address className="not-italic text-stone-300 leading-7">
              <strong className="text-amber-200">Ping IFF LLP</strong><br />
              745, Burail, Ekta Market, Burail Village,<br />
              Sector 45, Chandigarh &ndash; 160047, India<br />
              Phone: <a href="tel:+917347340007" className="hover:underline hover:text-amber-200 transition-colors">+91 73473 40007</a><br />
              Email: <a href="mailto:contact@pingiff.ai" className="hover:underline hover:text-amber-200 transition-colors">contact@pingiff.ai</a>
            </address>
          </div>
        </div>
      </section>
