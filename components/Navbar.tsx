...
const Navbar = () => {
  ...
  // Prevent hydration mismatch — cart count and auth state are always
  // empty/loading on the server, so defer client-only UI until after mount.
        ...
        <div className="w-full px-4 md:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-6 py-3 md:py-4">
                  ...
                  <div className="flex-1 overflow-y-auto py-6 space-y-4">
                    {items.length === 0 ? (
                      <div className="h-full flex flex-col items-center justify-center text-muted-foreground">
                        ...
                        <Button variant="link" onClick={() => { setCartOpen(false); router.push("/products"); }}>
                          Browse Products
                        </Button>
                      </div>
                    ) : (
            ...
            <div className="flex lg:hidden items-center gap-2">
              ...
              {mounted && !loading && user && <UserAvatar />}
