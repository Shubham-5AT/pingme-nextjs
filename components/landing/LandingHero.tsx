...
const LandingDownloadSection = dynamic(() => import("./LandingDownloadSection"), { ssr: false });
const LandingReviews = dynamic(() => import("../LandingReviews"), { ssr: false });
          ...
          <div className="mx-auto max-w-5xl space-y-5">
            {offerings.map((item, idx) => (
              <OfferingCard
                ...
                item={item}
                idx={idx}
                onClick={() => router.push(`/products/${item.categorySlug}`)}
              />
            ))}
          </div>
        </section>
