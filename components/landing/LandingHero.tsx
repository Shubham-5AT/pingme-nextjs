              ...
              <div className="relative aspect-[6/7] w-full overflow-hidden rounded-3xl border border-white/20 bg-transparent">  
                {heroImageUrl ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center p-8">
                    <img src={pingMeLogo.src} alt="PingME" className="max-h-[70%] max-w-[70%] object-contain" />
                  </div>
                )
                }
              </div>
...
/>
          ...
          <div className="mx-auto grid max-w-5xl gap-8 md:gap-20 lg:grid-cols-2">
            {offerings.map((item) => {
              ...
              return (
                <article key={item.title} className="overflow-hidden rounded-[1.75rem] border border-border/60 bg-background/90 shadow-[0_18px_50px_rgba(81,60,9,0.08)] cursor-pointer transition-all hover:shadow-[0_25px_60px_rgba(81,60,9,0.15)] hover:border-primary/40 hover:scale-[1.02]" onClick={() => router.push(`/products/${item.categorySlug}`)}>
